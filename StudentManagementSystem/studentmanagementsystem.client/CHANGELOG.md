...
- Create Angular project with ng: `ng new studentmanagementsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`studentmanagementsystem.client.esproj`).
